...
ActiveRecord::Schema.define(version: 0) do
  ...
  create_table "TESTnotesource", id: :integer, force: :cascade, options: "" do |t|
    t.integer "propid"
    t.text    "nscleaned", limit: 65535
    t.text    "nsraw",     limit: 65535
  end

  create_table "additionalarchitect", force: :cascade, options: "" do |t|
...
#    t.index ["yearflag"], name: "yearflag", using: :btree
  ...
  create_table "additionalbuilder", force: :cascade, options: "" do |t|
    t.integer "propid",               null: false
    t.string  "name",     limit: 128, null: false
    t.string  "year",     limit: 32
    t.string  "yearflag", limit: 1
...
#    t.index ["yearflag"], name: "yearflag", using: :btree
  ...
  create_table "ahdesignationvalue", primary_key: "value", id: :string, limit: 128, force: :cascade, options: "" do |t|
    t.index ["value"], name: "value", unique: true, using: :btree
  end

  create_table "alteration", force: :cascade, options: "" do |t|
    t.integer "propid",                  null: false
    t.integer "cost"
...
#    t.index ["yearflag"], name: "yearflag", using: :btree
  ...
  create_table "apn", force: :cascade, options: "" do |t|
    t.integer "propid",            null: false
    t.string  "parcel", limit: 16, null: false
#    t.index ["propid"], name: "propid", using: :btree
  end

  create_table "buildingpermit", force: :cascade, options: "" do |t|
    t.integer "propid",              null: false
...
#    t.index ["yearflag"], name: "yearflag", using: :btree
  ...
  create_table "chrscode", primary_key: "code", id: :string, limit: 6, force: :cascade, options: "" do |t|
    t.index ["code"], name: "code", unique: true, using: :btree
  end

  create_table "formeraddress", force: :cascade, options: "" do |t|
    t.integer "propid",               null: false
...
#    t.index ["propid"], name: "propid", using: :btree
  ...
  create_table "otherowner", force: :cascade, options: "" do |t|
    t.integer "propid",               null: false
    t.string  "name",     limit: 128, null: false
...
#    t.index ["yearflag"], name: "yearflag", using: :btree
  ...
  create_table "photo", force: :cascade, options: "" do |t|
    t.integer "propid",                  null: false
...
#    t.index ["propid"], name: "propid", using: :btree
  ...
  create_table "photos", force: :cascade, options: "" do |t|
    t.integer "propid",                 null: false
...
#    t.index ["propid"], name: "propid_index", using: :btree
  ...
  create_table "property", force: :cascade, options: "" do |t|
...
#    t.index ["yearbuiltflag"], name: "yearbuiltflag", using: :btree
  ...
  create_table "quadrantvalue", primary_key: "value", id: :string, limit: 32, force: :cascade, options: "" do |t|
#    t.index ["value"], name: "value", unique: true, using: :btree
  end

  create_table "scandoc", force: :cascade, options: "" do |t|
    t.integer "propid",                  null: false
    t.string  "filename",    limit: 64,  null: false
    t.string  "description", limit: 128
#    t.index ["filename"], name: "filename", unique: true, using: :btree
#    t.index ["propid"], name: "propid", using: :btree
  ...
  create_table "streetdirectionvalue", primary_key: "value", id: :string, limit: 1, force: :cascade, options: "" do |t|
#    t.index ["value"], name: "value", unique: true, using: :btree
  end

  create_table "stylevalue", primary_key: "value", id: :string, limit: 32, force: :cascade, options: "" do |t|
#    t.index ["value"], name: "value", unique: true, using: :btree
  end

  create_table "typevalue", primary_key: "value", id: :string, limit: 32, force: :cascade, options: "" do |t|
#    t.index ["value"], name: "value", unique: true, using: :btree
  end

  create_table "yearflag", primary_key: "flag", id: :string, limit: 1, force: :cascade, options: "" do |t|
    t.string "description", limit: 32
 #   t.index ["flag"], name: "flag", unique: true, using: :btree
  end

  create_table "yesnoflag", primary_key: "flag", id: :string, limit: 1, force: :cascade, options: "" do |t|
#    t.index ["flag"], name: "flag", unique: true, using: :btree
  end
