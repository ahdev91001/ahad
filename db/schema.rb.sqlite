...
ActiveRecord::Schema.define(version: 20181026193846) do
  ...
  create_table "additionalarchitect", id: false, force: :cascade, options: "" do |t|
  ...
  create_table "additionalbuilder", id: false, force: :cascade, options: "" do |t|
    t.integer "id",                   null: false
    t.integer "propid",               null: false
    t.string  "name",     limit: 128, null: false
    t.string  "year",     limit: 32
  ...
  create_table "ahdesignationvalue", id: false, force: :cascade, options: "" do |t|
    t.string "value", limit: 128, null: false
  end

  create_table "alteration", id: false, force: :cascade, options: "" do |t|
    t.integer "id",                      null: false
    t.integer "propid",                  null: false
    t.integer "cost"
  ...
  create_table "apn", id: false, force: :cascade, options: "" do |t|
    t.integer "id",                null: false
    t.integer "propid",            null: false
    t.string  "parcel", limit: 16, null: false
  end

  create_table "buildingpermit", id: false, force: :cascade, options: "" do |t|
    t.integer "id",                  null: false
    t.integer "propid",              null: false
  ...
  create_table "chrscode", id: false, force: :cascade, options: "" do |t|
    t.string "code", limit: 6, null: false
  end

  create_table "formeraddress", id: false, force: :cascade, options: "" do |t|
    t.integer "id",                   null: false
    t.integer "propid",               null: false
  ...
  create_table "otherowner", id: false, force: :cascade, options: "" do |t|
    t.integer "id",                   null: false
    t.integer "propid",               null: false
    t.string  "name",     limit: 128, null: false
  ...
  create_table "photo", id: false, force: :cascade, options: "" do |t|
    t.integer "id",                      null: false
    t.integer "propid",                  null: false
  ...
  create_table "photos", id: false, force: :cascade, options: "" do |t|
    t.integer "id",                     null: false
    t.integer "propid",                 null: false
